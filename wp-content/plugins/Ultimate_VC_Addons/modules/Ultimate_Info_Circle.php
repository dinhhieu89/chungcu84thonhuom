				...
				array(
				   ...
				   "params" => array(
						...
						*/
						...
						array(
							"type" => "heading",
							"sub_heading" => "<span style='display: block;'><a href='http://bsf.io/z-dpz' target='_blank'>Watch Video Tutorial &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
					...
					array(
					   ...
					   "params" => array(
						...
						array(
							"type" => "number",
							"class" => "",
							"heading" => __("Border Thickness", "smile"),
