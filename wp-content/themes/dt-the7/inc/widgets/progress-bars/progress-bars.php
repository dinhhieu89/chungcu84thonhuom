...
class Presscore_Inc_Widgets_ProgressBars extends WP_Widget {
	...
	function form( $instance ) {
		...
		<div class="dt-widget-sortable-container">
			...
			<?php endforeach;
			?></ul>
			<a href="javascript: void(0);" class="dt-widget-sortable-add button" data-fields-name="<?php echo $this->get_field_name( 'fields' ); ?>" data-field-type="progress-bar"><?php _ex( 'Add', 'widget', LANGUAGE_ZONE ); ?></a>
		</div>
